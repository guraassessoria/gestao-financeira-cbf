    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500">
          Estrutura CPC/IFRS · Mapeamento por faixa de contas Protheus
        </p>
      </div>
      ...
      <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-xl text-sm text-yellow-700">
        ⚠️ Mapeamento de contas pendente de aprovação. Os valores serão zerados até conclusão do De-Para.
      </div>
